  ...
  const FoodLobby = ({swal}) => {
    ...
    axios
      ...
      axios
        ...
        .then((response) => {
            const data = response.data.FoodSetting.filter(
              (entry) =>
                entry.userId === userId);
          setFoodSettings(data);
        })
        .catch((error) => {
          console.error("Error fetching food data:", error);
        });
    ...
    if (foodSettings.length > 0) {
      console.log(foodSettings[0].sum);
    }
    ...
    const sum = [
      {
        ...
        kcal: 100,
        fromKcal:
          foodSettings.length > 0 && foodSettings[0].sum
            ? foodSettings[0].sum
            : 2000,
        percent: function () {
          return (
    ...
    const totalG = [
      {
        ...
        g: 100,
        fromG:
          foodSettings.length > 0 && foodSettings[0].protein
            ? foodSettings[0].protein
            : 120,
        percent: function () {
      ...
      },
      {
        ...
        g: 12,
        fromG:
          foodSettings.length > 0 && foodSettings[0].carbs
            ? foodSettings[0].carbs
            : 250,
        percent: function () {
          return ((this.g / this.fromG) * 100).toFixed(0);
        },
      },
      {
        ...
        g: 11,
        fromG:
          foodSettings.length > 0 && foodSettings[0].fat
            ? foodSettings[0].fat
            : 50,
        percent: function () {
          return ((this.g / this.fromG) * 100).toFixed(0);
      ...
      },
      {
        ...
        g: 50,
        fromG:
          foodSettings.length > 0 && foodSettings[0].roughage
            ? foodSettings[0].roughage
            : 20,
        percent: function () {
          return ((this.g / this.fromG) * 100).toFixed(0);
        },
